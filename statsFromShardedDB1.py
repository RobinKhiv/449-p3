...
def get_top10users(db1: sqlite3.Connection = Depends(get_shard1), db2: sqlite3.Connection = Depends(get_shard2),
    ...
    logging.info("inside second instance-getting top10wins")
...
def get_top10streaks(
    ...
    logging.info("inside second instance-getting top10streaks")
...
if __name__ == "__main__":
    uvicorn.run("statsFromShardedDB1:app", host="0.0.0.0", port=5002, log_level="info")
